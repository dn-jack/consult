...
/**
 * Servlet implementation class DoctorAutograph
 */
@WebServlet("/DoctorAutograph")
public class DoctorAutograph extends HttpServlet {
	private static final long serialVersionUID = 1L;

	Logger logger = Logger.getLogger(DoctorAutograph.class);

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DoctorAutograph() {
		super();
				...
				if (!item.isFormField()) {
					...
					reJo.put(
							...
							request.getScheme() + "://"
									...
									+ temp_str + "/doctorAutograph/" + imageName);
					out.print(reJo);
				}
			}
		} catch (Exception e) {
